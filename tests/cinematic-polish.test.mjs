...
test("keeps the prologue skip control immediately visible and mobile-safe", async () => {
  ...
  assert.match(loader, /const version = "20260828-auto-prologue-ch2-1"/);
  assert.match(html, /cinematic-revamp\.css\?v=20260827-experience-1/);
  assert.match(html, /cinematic-revamp\.js\?v=20260828-auto-prologue-ch2-1/);
  assert.match(html, /audio=20260828-auto-prologue-ch2-1/);
...
test("gives all ten shadow poems a production carved stage and generated paper props", async () => {
  ...
  assert.match(loader, /const coreVersion = "20260828-auto-prologue-ch2-1"/);
  assert.match(legacy, /cinematic-revamp-core\.js\?v=20260828-auto-prologue-ch2-1/);
});
