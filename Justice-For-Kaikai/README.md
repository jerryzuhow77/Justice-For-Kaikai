...
- V6.0.2製作母稿、事實／證據架構、四語與資產規格、製作Scene Manifest。
...
public/media/           圖片、六首原創音樂影片與M4A網頁版
public/data/            Scene、資產與來源JSON
public/docs/            V6.0.2製作母稿與製作規格
...
git init
git add .
git commit -m "feat: publish Justice-For-Kaikai V6.0.2"
git branch -M main
